function qBittorrent_download {
    ...
    wget https://raw.githubusercontent.com/chinatengjie/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qBittorrent/qBittorrent%20$qBver%20-%20$libver/qbittorrent-nox && chmod +x $HOME/qbittorrent-nox
}
...
EOF
        ...
        wget  https://raw.githubusercontent.com/chinatengjie/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qb_password_gen && chmod +x $HOME/qb_password_gen
